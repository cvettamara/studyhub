...
import { MapPin, ShoppingBag, MessageSquare, Calendar } from "lucide-react"

const modules = [
  {
    name: "Мапа",
    description: "Пронајди ги најдобрите места за учење и сподели ги со другите",
    icon: MapPin,
  ...
  {
    name: "Маркет",
    description: "Размени, купи или продади материјали со други студенти",
    icon: ShoppingBag,
  ...
  {
    name: "Форум",
    description: "Поставувај прашања и споделувај знаење со другите студенти",
    icon: MessageSquare,
  ...
  {
    name: "Настани",
    description: "Пронајди група за учење или креирај своја",
    icon: Calendar,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-pretty text-lg text-slate-600">
            Учењето е полесно кога не си сам! Пронајди го совршеното место за учење, размени материјали, споделувај идеи и приклучи се на студентски настани — сè на едно место.
          </p>
          <div className="mt-8">
            <HeroIllustration />
          </div>
          ...
          <div className="relative z-10 text-center">
            <h3 className="mb-6 text-3xl font-extrabold sm:text-4xl lg:text-5xl">
              <span className="bg-gradient-to-r from-orange-500 via-pink-500 to-orange-600 bg-clip-text text-transparent">
                Твојот пат кон успехот започнува тука
              </span>
            </h3>
            <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed text-slate-700">
              Зад секој голем успех стои една едноставна одлука — да пробаш. Од подготовка за испити до групни проекти и нови интереси, тука не мораш сè да правиш сам/а. Придружи им се на илјадници студенти кои секојдневно си помагаат едни на други.
            </p>
