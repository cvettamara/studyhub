          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl shadow-emerald-100/50">
            {registered ? (
              <div className="text-center">
                ...
                <h1 className="mt-4 text-xl font-bold text-slate-800">Провери ја твојата е-пошта!</h1>
                <p className="mt-2 text-slate-500">
                  Испративме линк за потврда на <strong>{formData.email}</strong>. Кликни на него за да ја активираш сметката.
                </p>
                <Link href="/login" className="mt-6 inline-block text-orange-500 underline">
                  Веќе го потврди? Оди на најава
                </Link>
              </div>
            ) : (
              <>
                <h1 className="mb-2 text-2xl font-bold text-slate-800">
                  Приклучи се на факултетската заедница! 🎓
                </h1>
                <p className="mb-8 text-slate-600">
                  Креирај профил и поврзи се со другите студенти
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="индекс@feit.ukim.edu.mk"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="Креирај силна лозинка"
                        required
                      />
                      <button
                        type="button"
                  ...
                  <p className="text-center text-xs text-slate-500">
                    Со регистрација се согласуваш со нашите{" "}
                    <Link href="#" className="text-purple-600 hover:underline">Услови на користење</Link>
                    {" "}и{" "}
                    <Link href="#" className="text-purple-600 hover:underline">Политика на приватност</Link>
                  </p>
                </form>
              </>
            )}
